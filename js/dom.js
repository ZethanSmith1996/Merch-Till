export const dom = {
    ...
    recordDamageButton: document.getElementById("record-damage-button"),
    damageModal: document.getElementById("damage-modal"),
    damageContextLabel: document.getElementById("damage-context-label"),
    damageProductInput: document.getElementById("damage-product"),
    damageQuantityInput: document.getElementById("damage-quantity"),
    damageStockHelp: document.getElementById("damage-stock-help"),
    damageReasonInput: document.getElementById("damage-reason"),
    damageError: document.getElementById("damage-error"),
    closeDamageModalButton: document.getElementById("close-damage-modal"),
    cancelDamageButton: document.getElementById("cancel-damage-button"),
    saveDamageButton: document.getElementById("save-damage-button"),
